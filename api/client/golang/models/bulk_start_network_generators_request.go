...
func (m *BulkStartNetworkGeneratorsRequest) Validate(formats strfmt.Registry) error {
	var res []error
...
func (m *BulkStartNetworkGeneratorsRequest) validateDynamicResults(formats strfmt.Registry) error {
...
func (m *BulkStartNetworkGeneratorsRequest) validateIds(formats strfmt.Registry) error {
...
func (m *BulkStartNetworkGeneratorsRequest) contextValidateDynamicResults(ctx context.Context, formats strfmt.Registry) error {
...
func (m *BulkStartNetworkGeneratorsRequest) UnmarshalBinary(b []byte) error {
	var res BulkStartNetworkGeneratorsRequest
