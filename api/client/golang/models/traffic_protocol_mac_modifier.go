...
func (m *TrafficProtocolMacModifier) validateList(formats strfmt.Registry) error {
	...
	for i := 0; i < len(m.List); i++ {
		...
		if err := validate.Pattern("list"+"."+strconv.Itoa(i), "body", m.List[i], `^([0-9a-fA-F]{1,2}(.|-|:)){5}[0-9a-fA-F]{1,2}$`); err != nil {
			return err
		}
...
func (m *TrafficProtocolMacModifier) validateSequence(formats strfmt.Registry) error {
...
func (m *TrafficProtocolMacModifier) contextValidateSequence(ctx context.Context, formats strfmt.Registry) error {
...
func (m *TrafficProtocolMacModifier) UnmarshalBinary(b []byte) error {
	var res TrafficProtocolMacModifier
...
func (m *TrafficProtocolMacModifierSequence) Validate(formats strfmt.Registry) error {
	var res []error
...
func (m *TrafficProtocolMacModifierSequence) validateCount(formats strfmt.Registry) error {
...
func (m *TrafficProtocolMacModifierSequence) validateSkip(formats strfmt.Registry) error {
	...
	for i := 0; i < len(m.Skip); i++ {
		...
		if err := validate.Pattern("sequence"+"."+"skip"+"."+strconv.Itoa(i), "body", m.Skip[i], `^([0-9a-fA-F]{1,2}(.|-|:)){5}[0-9a-fA-F]{1,2}$`); err != nil {
			return err
		}
...
func (m *TrafficProtocolMacModifierSequence) validateStart(formats strfmt.Registry) error {

	if err := validate.Required("sequence"+"."+"start", "body", m.Start); err != nil {
		return err
	}

	if err := validate.Pattern("sequence"+"."+"start", "body", *m.Start, `^([0-9a-fA-F]{1,2}(.|-|:)){5}[0-9a-fA-F]{1,2}$`); err != nil {
		return err
	}
...
func (m *TrafficProtocolMacModifierSequence) validateStop(formats strfmt.Registry) error {
	if swag.IsZero(m.Stop) { // not required
		return nil
	}

	if err := validate.Pattern("sequence"+"."+"stop", "body", m.Stop, `^([0-9a-fA-F]{1,2}(.|-|:)){5}[0-9a-fA-F]{1,2}$`); err != nil {
		return err
	}
...
func (m *TrafficProtocolMacModifierSequence) UnmarshalBinary(b []byte) error {
	var res TrafficProtocolMacModifierSequence
	if err := swag.ReadJSON(b, &res); err != nil {
		return err
	}
	*m = res
