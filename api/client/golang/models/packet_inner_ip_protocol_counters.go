...
func (m *PacketInnerIPProtocolCounters) validateIPV4(formats strfmt.Registry) error {
...
func (m *PacketInnerIPProtocolCounters) validateIPV6(formats strfmt.Registry) error {
...
func (m *PacketInnerIPProtocolCounters) UnmarshalBinary(b []byte) error {
	var res PacketInnerIPProtocolCounters
