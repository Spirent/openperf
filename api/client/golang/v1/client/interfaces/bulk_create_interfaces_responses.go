...
func (o *BulkCreateInterfacesBody) contextValidateItems(ctx context.Context, formats strfmt.Registry) error {
...
func (o *BulkCreateInterfacesOKBody) contextValidateItems(ctx context.Context, formats strfmt.Registry) error {
