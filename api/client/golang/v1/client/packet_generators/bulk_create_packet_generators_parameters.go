...
// NewBulkCreatePacketGeneratorsParams creates a new BulkCreatePacketGeneratorsParams object,
...
func NewBulkCreatePacketGeneratorsParams() *BulkCreatePacketGeneratorsParams {
	return &BulkCreatePacketGeneratorsParams{
		timeout: cr.DefaultTimeout,
	}
}

// NewBulkCreatePacketGeneratorsParamsWithTimeout creates a new BulkCreatePacketGeneratorsParams object
...
// NewBulkCreatePacketGeneratorsParamsWithContext creates a new BulkCreatePacketGeneratorsParams object
...
// NewBulkCreatePacketGeneratorsParamsWithHTTPClient creates a new BulkCreatePacketGeneratorsParams object
...
func (o *BulkCreatePacketGeneratorsParams) WithDefaults() *BulkCreatePacketGeneratorsParams {
	o.SetDefaults()
	return o
}
...
func (o *BulkCreatePacketGeneratorsParams) WithTimeout(timeout time.Duration) *BulkCreatePacketGeneratorsParams {
...
func (o *BulkCreatePacketGeneratorsParams) WithContext(ctx context.Context) *BulkCreatePacketGeneratorsParams {
	o.SetContext(ctx)
	return o
}

// SetContext adds the context to the bulk create packet generators params
func (o *BulkCreatePacketGeneratorsParams) SetContext(ctx context.Context) {
	o.Context = ctx
}

// WithHTTPClient adds the HTTPClient to the bulk create packet generators params
func (o *BulkCreatePacketGeneratorsParams) WithHTTPClient(client *http.Client) *BulkCreatePacketGeneratorsParams {
...
func (o *BulkCreatePacketGeneratorsParams) WithCreate(create BulkCreatePacketGeneratorsBody) *BulkCreatePacketGeneratorsParams {
	o.SetCreate(create)
	return o
}

// SetCreate adds the create to the bulk create packet generators params
func (o *BulkCreatePacketGeneratorsParams) SetCreate(create BulkCreatePacketGeneratorsBody) {
	o.Create = create
}

// WriteToRequest writes these params to a swagger request
func (o *BulkCreatePacketGeneratorsParams) WriteToRequest(r runtime.ClientRequest, reg strfmt.Registry) error {
