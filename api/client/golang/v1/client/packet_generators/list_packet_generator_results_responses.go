...
func (o *ListPacketGeneratorResultsReader) ReadResponse(response runtime.ClientResponse, consumer runtime.Consumer) (interface{}, error) {
	...
	case 200:
		result := NewListPacketGeneratorResultsOK()
...
func NewListPacketGeneratorResultsOK() *ListPacketGeneratorResultsOK {
	return &ListPacketGeneratorResultsOK{}
}
...
func (o *ListPacketGeneratorResultsOK) Error() string {
	return fmt.Sprintf("[GET /packet/generator-results][%d] listPacketGeneratorResultsOK  %+v", 200, o.Payload)
}
func (o *ListPacketGeneratorResultsOK) GetPayload() []*models.PacketGeneratorResult {
	return o.Payload
}

func (o *ListPacketGeneratorResultsOK) readResponse(response runtime.ClientResponse, consumer runtime.Consumer, formats strfmt.Registry) error {
