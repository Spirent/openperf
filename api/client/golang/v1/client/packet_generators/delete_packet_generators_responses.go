...
func (o *DeletePacketGeneratorsReader) ReadResponse(response runtime.ClientResponse, consumer runtime.Consumer) (interface{}, error) {
	...
	case 204:
		result := NewDeletePacketGeneratorsNoContent()
...
func NewDeletePacketGeneratorsNoContent() *DeletePacketGeneratorsNoContent {
	return &DeletePacketGeneratorsNoContent{}
}
...
func (o *DeletePacketGeneratorsNoContent) Error() string {
	return fmt.Sprintf("[DELETE /packet/generators][%d] deletePacketGeneratorsNoContent ", 204)
}

func (o *DeletePacketGeneratorsNoContent) readResponse(response runtime.ClientResponse, consumer runtime.Consumer, formats strfmt.Registry) error {
