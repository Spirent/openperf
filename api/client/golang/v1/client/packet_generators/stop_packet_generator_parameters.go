...
// NewStopPacketGeneratorParams creates a new StopPacketGeneratorParams object,
...
func NewStopPacketGeneratorParams() *StopPacketGeneratorParams {
	return &StopPacketGeneratorParams{
		timeout: cr.DefaultTimeout,
	}
}

// NewStopPacketGeneratorParamsWithTimeout creates a new StopPacketGeneratorParams object
...
// NewStopPacketGeneratorParamsWithContext creates a new StopPacketGeneratorParams object
...
// NewStopPacketGeneratorParamsWithHTTPClient creates a new StopPacketGeneratorParams object
...
func (o *StopPacketGeneratorParams) WithDefaults() *StopPacketGeneratorParams {
	o.SetDefaults()
	return o
}
...
func (o *StopPacketGeneratorParams) WithTimeout(timeout time.Duration) *StopPacketGeneratorParams {
...
func (o *StopPacketGeneratorParams) WithContext(ctx context.Context) *StopPacketGeneratorParams {
	o.SetContext(ctx)
	return o
}
...
func (o *StopPacketGeneratorParams) WithID(id string) *StopPacketGeneratorParams {
	o.SetID(id)
	return o
}
...
func (o *StopPacketGeneratorParams) WriteToRequest(r runtime.ClientRequest, reg strfmt.Registry) error {
