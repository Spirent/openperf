...
func (o *ListTvlpConfigurationsReader) ReadResponse(response runtime.ClientResponse, consumer runtime.Consumer) (interface{}, error) {
	...
	case 200:
		result := NewListTvlpConfigurationsOK()
...
func NewListTvlpConfigurationsOK() *ListTvlpConfigurationsOK {
	return &ListTvlpConfigurationsOK{}
}
...
func (o *ListTvlpConfigurationsOK) Error() string {
	return fmt.Sprintf("[GET /tvlp][%d] listTvlpConfigurationsOK  %+v", 200, o.Payload)
}
func (o *ListTvlpConfigurationsOK) GetPayload() []*models.TvlpConfiguration {
	return o.Payload
}

func (o *ListTvlpConfigurationsOK) readResponse(response runtime.ClientResponse, consumer runtime.Consumer, formats strfmt.Registry) error {
