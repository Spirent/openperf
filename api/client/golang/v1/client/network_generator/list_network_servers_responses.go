...
func (o *ListNetworkServersReader) ReadResponse(response runtime.ClientResponse, consumer runtime.Consumer) (interface{}, error) {
	...
	case 200:
		result := NewListNetworkServersOK()
...
func (o *ListNetworkServersOK) Error() string {
	return fmt.Sprintf("[GET /network/servers][%d] listNetworkServersOK  %+v", 200, o.Payload)
}
func (o *ListNetworkServersOK) GetPayload() []*models.NetworkServer {
	return o.Payload
}

func (o *ListNetworkServersOK) readResponse(response runtime.ClientResponse, consumer runtime.Consumer, formats strfmt.Registry) error {
