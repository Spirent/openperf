...
func (o *ListNetworkGeneratorsReader) ReadResponse(response runtime.ClientResponse, consumer runtime.Consumer) (interface{}, error) {
	...
	case 200:
		result := NewListNetworkGeneratorsOK()
...
func NewListNetworkGeneratorsOK() *ListNetworkGeneratorsOK {
	return &ListNetworkGeneratorsOK{}
}
...
func (o *ListNetworkGeneratorsOK) Error() string {
	return fmt.Sprintf("[GET /network/generators][%d] listNetworkGeneratorsOK  %+v", 200, o.Payload)
}
func (o *ListNetworkGeneratorsOK) GetPayload() []*models.NetworkGenerator {
	return o.Payload
}

func (o *ListNetworkGeneratorsOK) readResponse(response runtime.ClientResponse, consumer runtime.Consumer, formats strfmt.Registry) error {
