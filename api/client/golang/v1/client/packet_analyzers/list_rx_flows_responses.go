...
func (o *ListRxFlowsOK) Error() string {
	return fmt.Sprintf("[GET /packet/rx-flows][%d] listRxFlowsOK  %+v", 200, o.Payload)
}
func (o *ListRxFlowsOK) GetPayload() []*models.RxFlow {
	return o.Payload
}

func (o *ListRxFlowsOK) readResponse(response runtime.ClientResponse, consumer runtime.Consumer, formats strfmt.Registry) error {
