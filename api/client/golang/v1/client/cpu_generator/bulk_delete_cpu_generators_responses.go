...
func (o *BulkDeleteCPUGeneratorsReader) ReadResponse(response runtime.ClientResponse, consumer runtime.Consumer) (interface{}, error) {
	...
	case 204:
		result := NewBulkDeleteCPUGeneratorsNoContent()
...
func NewBulkDeleteCPUGeneratorsNoContent() *BulkDeleteCPUGeneratorsNoContent {
	return &BulkDeleteCPUGeneratorsNoContent{}
}
...
func (o *BulkDeleteCPUGeneratorsNoContent) Error() string {
	return fmt.Sprintf("[POST /cpu-generators/x/bulk-delete][%d] bulkDeleteCpuGeneratorsNoContent ", 204)
}

func (o *BulkDeleteCPUGeneratorsNoContent) readResponse(response runtime.ClientResponse, consumer runtime.Consumer, formats strfmt.Registry) error {

	return nil
}

/*BulkDeleteCPUGeneratorsBody BulkDeleteCpuGeneratorsRequest
//
// Parameters for the bulk delete operation
swagger:model BulkDeleteCPUGeneratorsBody
*/
...
func (o *BulkDeleteCPUGeneratorsBody) validateIds(formats strfmt.Registry) error {
...
func (o *BulkDeleteCPUGeneratorsBody) UnmarshalBinary(b []byte) error {
	var res BulkDeleteCPUGeneratorsBody
