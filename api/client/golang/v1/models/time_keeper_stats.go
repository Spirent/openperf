...
func (m *TimeKeeperStats) ContextValidate(ctx context.Context, formats strfmt.Registry) error {
	...
	if err := m.contextValidateRoundTripTimes(ctx, formats); err != nil {
		res = append(res, err)
	}
...
func (m *TimeKeeperStats) contextValidateRoundTripTimes(ctx context.Context, formats strfmt.Registry) error {

	if m.RoundTripTimes != nil {
		if err := m.RoundTripTimes.ContextValidate(ctx, formats); err != nil {
			if ve, ok := err.(*errors.Validation); ok {
				return ve.ValidateName("round_trip_times")
			}
			return err
