...
func (o *BulkDeletePacketAnalyzersReader) ReadResponse(response runtime.ClientResponse, consumer runtime.Consumer) (interface{}, error) {
	...
	case 204:
		result := NewBulkDeletePacketAnalyzersNoContent()
...
func NewBulkDeletePacketAnalyzersNoContent() *BulkDeletePacketAnalyzersNoContent {
	return &BulkDeletePacketAnalyzersNoContent{}
}
...
func (o *BulkDeletePacketAnalyzersNoContent) Error() string {
	return fmt.Sprintf("[POST /packet/analyzers/x/bulk-delete][%d] bulkDeletePacketAnalyzersNoContent ", 204)
}

func (o *BulkDeletePacketAnalyzersNoContent) readResponse(response runtime.ClientResponse, consumer runtime.Consumer, formats strfmt.Registry) error {

	return nil
}

/*BulkDeletePacketAnalyzersBody BulkDeletePacketAnalyzersRequest
//
// Parameters for the bulk delete operation
swagger:model BulkDeletePacketAnalyzersBody
*/
...
func (o *BulkDeletePacketAnalyzersBody) validateIds(formats strfmt.Registry) error {
...
func (o *BulkDeletePacketAnalyzersBody) UnmarshalBinary(b []byte) error {
	var res BulkDeletePacketAnalyzersBody
