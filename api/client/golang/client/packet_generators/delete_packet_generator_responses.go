...
func (o *DeletePacketGeneratorReader) ReadResponse(response runtime.ClientResponse, consumer runtime.Consumer) (interface{}, error) {
	...
	case 204:
		result := NewDeletePacketGeneratorNoContent()
...
func NewDeletePacketGeneratorNoContent() *DeletePacketGeneratorNoContent {
	return &DeletePacketGeneratorNoContent{}
}
...
func (o *DeletePacketGeneratorNoContent) Error() string {
	return fmt.Sprintf("[DELETE /packet/generators/{id}][%d] deletePacketGeneratorNoContent ", 204)
}

func (o *DeletePacketGeneratorNoContent) readResponse(response runtime.ClientResponse, consumer runtime.Consumer, formats strfmt.Registry) error {
