...
// NewDeletePacketGeneratorParams creates a new DeletePacketGeneratorParams object,
...
func NewDeletePacketGeneratorParams() *DeletePacketGeneratorParams {
	return &DeletePacketGeneratorParams{
		timeout: cr.DefaultTimeout,
	}
}

// NewDeletePacketGeneratorParamsWithTimeout creates a new DeletePacketGeneratorParams object
...
// NewDeletePacketGeneratorParamsWithContext creates a new DeletePacketGeneratorParams object
...
// NewDeletePacketGeneratorParamsWithHTTPClient creates a new DeletePacketGeneratorParams object
...
func (o *DeletePacketGeneratorParams) WithDefaults() *DeletePacketGeneratorParams {
	o.SetDefaults()
	return o
}
...
func (o *DeletePacketGeneratorParams) WithTimeout(timeout time.Duration) *DeletePacketGeneratorParams {
...
func (o *DeletePacketGeneratorParams) WithContext(ctx context.Context) *DeletePacketGeneratorParams {
	o.SetContext(ctx)
	return o
}
...
func (o *DeletePacketGeneratorParams) WithHTTPClient(client *http.Client) *DeletePacketGeneratorParams {
...
func (o *DeletePacketGeneratorParams) WithID(id string) *DeletePacketGeneratorParams {
	o.SetID(id)
	return o
}
...
func (o *DeletePacketGeneratorParams) WriteToRequest(r runtime.ClientRequest, reg strfmt.Registry) error {
