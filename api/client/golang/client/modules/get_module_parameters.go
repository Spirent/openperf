...
// WithDefaults hydrates default values in the get module params (not the query body).
//
// All values with no default are reset to their zero value.
func (o *GetModuleParams) WithDefaults() *GetModuleParams {
	o.SetDefaults()
	return o
}

// SetDefaults hydrates default values in the get module params (not the query body).
//
// All values with no default are reset to their zero value.
func (o *GetModuleParams) SetDefaults() {
