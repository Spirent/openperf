...
/* ListModulesParams contains all the parameters to send to the API endpoint
   for the list modules operation.
...
// WithDefaults hydrates default values in the list modules params (not the query body).
//
// All values with no default are reset to their zero value.
func (o *ListModulesParams) WithDefaults() *ListModulesParams {
	o.SetDefaults()
	return o
}

// SetDefaults hydrates default values in the list modules params (not the query body).
//
// All values with no default are reset to their zero value.
func (o *ListModulesParams) SetDefaults() {
