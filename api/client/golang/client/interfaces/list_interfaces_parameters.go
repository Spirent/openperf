...
func (o *ListInterfacesParams) WriteToRequest(r runtime.ClientRequest, reg strfmt.Registry) error {
	...
	if o.IPV6Address != nil {
		...
		// query param ipv6_address
		var qrIPV6Address string

		if o.IPV6Address != nil {
			qrIPV6Address = *o.IPV6Address
		}
		qIPV6Address := qrIPV6Address
		if qIPV6Address != "" {

			if err := r.SetQueryParam("ipv6_address", qIPV6Address); err != nil {
				return err
			}
		}
	}
