...
// NewDeleteCPUGeneratorResultParams creates a new DeleteCPUGeneratorResultParams object,
...
func NewDeleteCPUGeneratorResultParams() *DeleteCPUGeneratorResultParams {
	return &DeleteCPUGeneratorResultParams{
		timeout: cr.DefaultTimeout,
	}
}

// NewDeleteCPUGeneratorResultParamsWithTimeout creates a new DeleteCPUGeneratorResultParams object
...
// NewDeleteCPUGeneratorResultParamsWithContext creates a new DeleteCPUGeneratorResultParams object
...
// NewDeleteCPUGeneratorResultParamsWithHTTPClient creates a new DeleteCPUGeneratorResultParams object
...
func (o *DeleteCPUGeneratorResultParams) WithDefaults() *DeleteCPUGeneratorResultParams {
	o.SetDefaults()
	return o
}
...
func (o *DeleteCPUGeneratorResultParams) WithTimeout(timeout time.Duration) *DeleteCPUGeneratorResultParams {
...
func (o *DeleteCPUGeneratorResultParams) WithContext(ctx context.Context) *DeleteCPUGeneratorResultParams {
	o.SetContext(ctx)
	return o
}
...
func (o *DeleteCPUGeneratorResultParams) WithHTTPClient(client *http.Client) *DeleteCPUGeneratorResultParams {
...
func (o *DeleteCPUGeneratorResultParams) WithID(id string) *DeleteCPUGeneratorResultParams {
	o.SetID(id)
	return o
}

// SetID adds the id to the delete Cpu generator result params
func (o *DeleteCPUGeneratorResultParams) SetID(id string) {
	o.ID = id
}

// WriteToRequest writes these params to a swagger request
func (o *DeleteCPUGeneratorResultParams) WriteToRequest(r runtime.ClientRequest, reg strfmt.Registry) error {
