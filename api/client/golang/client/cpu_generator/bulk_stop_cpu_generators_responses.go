...
func (o *BulkStopCPUGeneratorsReader) ReadResponse(response runtime.ClientResponse, consumer runtime.Consumer) (interface{}, error) {
	...
	case 204:
		result := NewBulkStopCPUGeneratorsNoContent()
...
func NewBulkStopCPUGeneratorsNoContent() *BulkStopCPUGeneratorsNoContent {
	return &BulkStopCPUGeneratorsNoContent{}
}
...
func (o *BulkStopCPUGeneratorsNoContent) Error() string {
	return fmt.Sprintf("[POST /cpu-generators/x/bulk-stop][%d] bulkStopCpuGeneratorsNoContent ", 204)
}

func (o *BulkStopCPUGeneratorsNoContent) readResponse(response runtime.ClientResponse, consumer runtime.Consumer, formats strfmt.Registry) error {

	return nil
}

/*BulkStopCPUGeneratorsBody BulkStopCpuGeneratorsRequest
//
// Parameters for the bulk stop operation
swagger:model BulkStopCPUGeneratorsBody
*/
...
func (o *BulkStopCPUGeneratorsBody) validateIds(formats strfmt.Registry) error {
...
func (o *BulkStopCPUGeneratorsBody) UnmarshalBinary(b []byte) error {
	var res BulkStopCPUGeneratorsBody
