...
func (o *BulkDeleteNetworkServersReader) ReadResponse(response runtime.ClientResponse, consumer runtime.Consumer) (interface{}, error) {
	...
	case 204:
		result := NewBulkDeleteNetworkServersNoContent()
...
func NewBulkDeleteNetworkServersNoContent() *BulkDeleteNetworkServersNoContent {
	return &BulkDeleteNetworkServersNoContent{}
}
...
func (o *BulkDeleteNetworkServersNoContent) Error() string {
	return fmt.Sprintf("[POST /network/servers/x/bulk-delete][%d] bulkDeleteNetworkServersNoContent ", 204)
}

func (o *BulkDeleteNetworkServersNoContent) readResponse(response runtime.ClientResponse, consumer runtime.Consumer, formats strfmt.Registry) error {

	return nil
}

/*BulkDeleteNetworkServersBody BulkDeleteNetworkServersRequest
//
// Parameters for the bulk delete operation
swagger:model BulkDeleteNetworkServersBody
*/
...
func (o *BulkDeleteNetworkServersBody) validateIds(formats strfmt.Registry) error {
...
func (o *BulkDeleteNetworkServersBody) UnmarshalBinary(b []byte) error {
	var res BulkDeleteNetworkServersBody
