...
func (o *DeleteNetworkGeneratorResultReader) ReadResponse(response runtime.ClientResponse, consumer runtime.Consumer) (interface{}, error) {
	...
	case 204:
		result := NewDeleteNetworkGeneratorResultNoContent()
...
func NewDeleteNetworkGeneratorResultNoContent() *DeleteNetworkGeneratorResultNoContent {
	return &DeleteNetworkGeneratorResultNoContent{}
}
...
func (o *DeleteNetworkGeneratorResultNoContent) Error() string {
	return fmt.Sprintf("[DELETE /network/generator-results/{id}][%d] deleteNetworkGeneratorResultNoContent ", 204)
}

func (o *DeleteNetworkGeneratorResultNoContent) readResponse(response runtime.ClientResponse, consumer runtime.Consumer, formats strfmt.Registry) error {
