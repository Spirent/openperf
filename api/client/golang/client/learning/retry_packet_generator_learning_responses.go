...
func (o *RetryPacketGeneratorLearningReader) ReadResponse(response runtime.ClientResponse, consumer runtime.Consumer) (interface{}, error) {
	...
	case 204:
		result := NewRetryPacketGeneratorLearningNoContent()
...
func NewRetryPacketGeneratorLearningNoContent() *RetryPacketGeneratorLearningNoContent {
	return &RetryPacketGeneratorLearningNoContent{}
}
...
func (o *RetryPacketGeneratorLearningNoContent) Error() string {
	return fmt.Sprintf("[POST /packet/generators/{id}/learning/retry][%d] retryPacketGeneratorLearningNoContent ", 204)
}

func (o *RetryPacketGeneratorLearningNoContent) readResponse(response runtime.ClientResponse, consumer runtime.Consumer, formats strfmt.Registry) error {
