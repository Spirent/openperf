...
// NewDeletePacketCaptureResultsParams creates a new DeletePacketCaptureResultsParams object,
...
func NewDeletePacketCaptureResultsParams() *DeletePacketCaptureResultsParams {
	return &DeletePacketCaptureResultsParams{
		timeout: cr.DefaultTimeout,
	}
}

// NewDeletePacketCaptureResultsParamsWithTimeout creates a new DeletePacketCaptureResultsParams object
...
// NewDeletePacketCaptureResultsParamsWithContext creates a new DeletePacketCaptureResultsParams object
...
// NewDeletePacketCaptureResultsParamsWithHTTPClient creates a new DeletePacketCaptureResultsParams object
...
func (o *DeletePacketCaptureResultsParams) WithDefaults() *DeletePacketCaptureResultsParams {
	o.SetDefaults()
	return o
}
...
func (o *DeletePacketCaptureResultsParams) WithTimeout(timeout time.Duration) *DeletePacketCaptureResultsParams {
...
func (o *DeletePacketCaptureResultsParams) WithContext(ctx context.Context) *DeletePacketCaptureResultsParams {
	o.SetContext(ctx)
	return o
}

// SetContext adds the context to the delete packet capture results params
func (o *DeletePacketCaptureResultsParams) SetContext(ctx context.Context) {
	o.Context = ctx
}

// WithHTTPClient adds the HTTPClient to the delete packet capture results params
func (o *DeletePacketCaptureResultsParams) WithHTTPClient(client *http.Client) *DeletePacketCaptureResultsParams {
...
func (o *DeletePacketCaptureResultsParams) WriteToRequest(r runtime.ClientRequest, reg strfmt.Registry) error {
