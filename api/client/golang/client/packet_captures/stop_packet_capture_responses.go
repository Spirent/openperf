...
func (o *StopPacketCaptureReader) ReadResponse(response runtime.ClientResponse, consumer runtime.Consumer) (interface{}, error) {
	...
	case 204:
		result := NewStopPacketCaptureNoContent()
...
func NewStopPacketCaptureNoContent() *StopPacketCaptureNoContent {
	return &StopPacketCaptureNoContent{}
}
...
func (o *StopPacketCaptureNoContent) Error() string {
	return fmt.Sprintf("[POST /packet/captures/{id}/stop][%d] stopPacketCaptureNoContent ", 204)
}

func (o *StopPacketCaptureNoContent) readResponse(response runtime.ClientResponse, consumer runtime.Consumer, formats strfmt.Registry) error {
