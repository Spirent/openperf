...
// NewStopPacketCaptureParams creates a new StopPacketCaptureParams object,
...
func NewStopPacketCaptureParams() *StopPacketCaptureParams {
	return &StopPacketCaptureParams{
		timeout: cr.DefaultTimeout,
	}
}

// NewStopPacketCaptureParamsWithTimeout creates a new StopPacketCaptureParams object
...
// NewStopPacketCaptureParamsWithContext creates a new StopPacketCaptureParams object
...
// NewStopPacketCaptureParamsWithHTTPClient creates a new StopPacketCaptureParams object
...
func (o *StopPacketCaptureParams) WithDefaults() *StopPacketCaptureParams {
	o.SetDefaults()
	return o
}
...
func (o *StopPacketCaptureParams) WithTimeout(timeout time.Duration) *StopPacketCaptureParams {
...
func (o *StopPacketCaptureParams) WithContext(ctx context.Context) *StopPacketCaptureParams {
	o.SetContext(ctx)
	return o
}
...
func (o *StopPacketCaptureParams) WithID(id string) *StopPacketCaptureParams {
	o.SetID(id)
	return o
}
...
func (o *StopPacketCaptureParams) WriteToRequest(r runtime.ClientRequest, reg strfmt.Registry) error {
