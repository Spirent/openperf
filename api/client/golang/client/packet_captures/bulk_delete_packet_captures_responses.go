...
func (o *BulkDeletePacketCapturesReader) ReadResponse(response runtime.ClientResponse, consumer runtime.Consumer) (interface{}, error) {
	...
	case 204:
		result := NewBulkDeletePacketCapturesNoContent()
...
func NewBulkDeletePacketCapturesNoContent() *BulkDeletePacketCapturesNoContent {
	return &BulkDeletePacketCapturesNoContent{}
}
...
func (o *BulkDeletePacketCapturesNoContent) Error() string {
	return fmt.Sprintf("[POST /packet/captures/x/bulk-delete][%d] bulkDeletePacketCapturesNoContent ", 204)
}

func (o *BulkDeletePacketCapturesNoContent) readResponse(response runtime.ClientResponse, consumer runtime.Consumer, formats strfmt.Registry) error {

	return nil
}

/*BulkDeletePacketCapturesBody BulkDeletePacketCapturesRequest
//
// Parameters for the bulk delete operation
swagger:model BulkDeletePacketCapturesBody
*/
...
func (o *BulkDeletePacketCapturesBody) validateIds(formats strfmt.Registry) error {
...
func (o *BulkDeletePacketCapturesBody) UnmarshalBinary(b []byte) error {
	var res BulkDeletePacketCapturesBody
