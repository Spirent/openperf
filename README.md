...
This code base provides a framework for easily allowing applications to access
and use a user-mode networking stack.  Stack functionality is provided by
[lwip](https://savannah.nongnu.org/projects/lwip/), a lightweight TCP/IP stack.
Network connectivity is provided by [DPDK](https://www.dpdk.org). Configuration
and management of network ports and interfaces is handled either via a
[REST API](api/schema/v1/inception-core.yaml) or a run-time configuration
file.
