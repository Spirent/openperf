...
The `loop` is instanciated by the module. Its type is the C++ class [`openperf::core::event_loop`](https://github.com/SpirentOrion/openperf-core/blob/master/src/framework/core/op_event_loop.hpp#L11), which wraps the `op_event_loop_xxx` functions.
