...
Hopefully, this guide has helped you understand how to use OpenPerf
with 3rd party applications. Clearly, the `ping` output shows we still
have a lot of work left to do. Please help if you can!
