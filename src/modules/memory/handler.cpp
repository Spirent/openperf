...
public:
    ...
    void bulk_start_generators(
        const Rest::Request& request, Http::ResponseWriter response);
    void bulk_stop_generators(
        const Rest::Request& request, Http::ResponseWriter response);
        ...
        context, ZMQ_REQ, openperf::memory::api::endpoint.data()))
{
    ...
    Rest::Routes::Get(router,
        "/memory_info",
        Rest::Routes::bind(&handler::get_info, this));
}
...
{
    json api_request = {
            {"type", request_type::CREATE_GENERATOR},
            {"data", request.body()}
        };
    ...
    Http::ResponseWriter response)
{
    ...
    json api_request = {
            {"type", request_type::GET_GENERATOR},
            {"id", id}
        };
    ...
    Http::ResponseWriter response)
{
    ...
    json api_request = {
            {"type", request_type::DELETE_GENERATOR},
            {"id", id}
        };
    ...
    Http::ResponseWriter response)
{
    ...
    json api_request = {
            {"type", request_type::START_GENERATOR},
            {"id", id}
        };
    ...
    Http::ResponseWriter response)
{
    ...
    json api_request = {
            {"type", request_type::STOP_GENERATOR},
            {"id", id}
        };
    ...
    Http::ResponseWriter response)
{
    try {
        ...
        if (body.find("ids") != body.end()) {
            json api_request = {
                    {"type", request_type::BULK_START_GENERATORS},
                    {"ids", body["ids"]}
                };
    ...
    Http::ResponseWriter response)
{
    try {
        ...
        if (body.find("ids") != body.end()) {
            json api_request = {
                    {"type", request_type::BULK_STOP_GENERATORS},
                    {"ids", body["ids"]}
                };
    ...
    Http::ResponseWriter response)
{
    ...
    json api_request = {
            {"type", request_type::DELETE_RESULT},
            {"id", id}
        };
