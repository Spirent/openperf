...
void* memp_malloc(memp_t type)
{
    ...
    switch (type) {
    case MEMP_PBUF:
        to_return = packetio_memory_pbuf_ref_rom_alloc();
        break;
    case MEMP_PBUF_POOL:
        to_return = packetio_memory_pbuf_default_alloc();
        break;
    default:
        to_return = packetio_memory_alloc(memp_pools[type]->desc,
...
void memp_free(memp_t type, void* mem)
{
    ...
    case MEMP_PBUF:
    case MEMP_PBUF_POOL:
        packetio_memory_pbuf_free((struct pbuf*)mem);
        break;
    default:
        packetio_memory_free(mem);
