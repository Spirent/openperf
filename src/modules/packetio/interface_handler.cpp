...
public:
    ...
    void list_interfaces(const Rest::Request& request,
                         Http::ResponseWriter response);
    void create_interface(const Rest::Request& request,
                          Http::ResponseWriter response);
    void get_interface(const Rest::Request& request,
                       Http::ResponseWriter response);
    void delete_interface(const Rest::Request& request,
                          Http::ResponseWriter response);

    /* Bulk interface options */
    void bulk_create_interfaces(const Rest::Request& request,
                                Http::ResponseWriter response);
    void bulk_delete_interfaces(const Rest::Request& request,
                                Http::ResponseWriter response);
...
void handler::list_interfaces(const Rest::Request& request,
                              Http::ResponseWriter response)
{
    json api_request = {{"type", request_type::LIST_INTERFACES}};
...
void handler::create_interface(const Rest::Request& request,
                               Http::ResponseWriter response)
{
    json api_request = {{"type", request_type::CREATE_INTERFACE},
                        {"data", request.body()}};
                                     ...
                                     Http::ResponseWriter response)
{
    ...
    try {
        ...
        if (body.find("items") != body.end()) {
            json api_request = {{"type", request_type::BULK_CREATE_INTERFACES},
                                {"items", body["items"]}};
                                     ...
                                     Http::ResponseWriter response)
{
    try {
        ...
        if (body.find("ids") != body.end()) {
            json api_request = {{"type", request_type::BULK_DELETE_INTERFACES},
                                {"ids", body["ids"]}};
            submit_request(socket.get(), api_request);
        }
        response.send(Http::Code::No_Content);
