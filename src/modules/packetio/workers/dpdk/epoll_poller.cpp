...
task_ptr to_task_ptr(void* ptr)
{
    ...
    case variant_index<task_ptr, callback*>():
        return (reinterpret_cast<callback*>(reinterpret_cast<uintptr_t>(ptr)
                                            & ptr_mask));
    case variant_index<task_ptr, rx_queue*>():
        return (reinterpret_cast<rx_queue*>(reinterpret_cast<uintptr_t>(ptr)
                                            & ptr_mask));
    case variant_index<task_ptr, tx_queue*>():
        return (reinterpret_cast<tx_queue*>(reinterpret_cast<uintptr_t>(ptr)
                                            & ptr_mask));
    case variant_index<task_ptr, tx_scheduler*>():
        return (reinterpret_cast<tx_scheduler*>(reinterpret_cast<uintptr_t>(ptr)
                                                & ptr_mask));
    case variant_index<task_ptr, zmq_socket*>():
        return (reinterpret_cast<zmq_socket*>(reinterpret_cast<uintptr_t>(ptr)
                                              & ptr_mask));
    default:
