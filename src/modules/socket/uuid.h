#ifndef _ICP_SOCK_UUID_H_
#define _ICP_SOCK_UUID_H_
...
template <>
struct hash<icp::sock::uuid>
{
    size_t operator()(const icp::sock::uuid& uuid) const noexcept
    {
