...
public:
    ...
    /* getsockopt handlers */
    virtual tl::expected<socklen_t, int> do_getsockopt(const raw_pcb*, const api::request_getsockopt&);
    ...
    /* setsockopt handlers */
    virtual tl::expected<void, int> do_setsockopt(raw_pcb*, const api::request_setsockopt&);
