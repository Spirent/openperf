...
/*
 * Provide a sane maximum payload size for clients.  This value works for
 * both IPv4/IPv6 and the standard Ethernet MTU of 1500.  If we support
 * other interfaces or adjustable MTU's, then we'll need to add dynamic
 * sizing.
 * Note: 1500 - 40 (IPv6 header) - 8 (UDP header) = 1452.
 */

static constexpr decltype(dgram_channel_descriptor::length) max_dgram_length = 1452;
