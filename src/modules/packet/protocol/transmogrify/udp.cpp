...
std::shared_ptr<swagger::v1::model::PacketProtocolUdp> to_swagger(packet::protocol::udp& src)
{
...
packet::protocol::udp to_protocol(std::shared_ptr<swagger::v1::model::PacketProtocolUdp>& src)
{
    auto dst = packet::protocol::udp{};
