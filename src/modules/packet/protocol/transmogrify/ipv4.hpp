...
packet::protocol::ipv4 to_protocol(std::shared_ptr<swagger::v1::model::PacketProtocolIpv4>&);

std::shared_ptr<swagger::v1::model::PacketProtocolIpv4> to_swagger(packet::protocol::ipv4&);
