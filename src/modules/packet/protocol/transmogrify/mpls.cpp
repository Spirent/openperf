...
std::shared_ptr<swagger::v1::model::PacketProtocolMpls> to_swagger(packet::protocol::mpls& src)
{
...
packet::protocol::mpls to_protocol(std::shared_ptr<swagger::v1::model::PacketProtocolMpls>& src)
{
    auto dst = packet::protocol::mpls{};
