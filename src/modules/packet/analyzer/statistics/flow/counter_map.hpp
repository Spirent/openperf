#ifndef _OP_ANALYZER_STATISTICS_FLOW_COUNTER_MAP_HPP_
#define _OP_ANALYZER_STATISTICS_FLOW_COUNTER_MAP_HPP_
...
template <typename FlowStats> class counter_map
{
public:
    counter_map();
    ~counter_map();
...
#endif /* _OP_ANALYZER_STATISTICS_FLOW_COUNTER_MAP_HPP_ */
