#ifndef _OP_PACKET_STACK_GSO_UTILS_H_
#define _OP_PACKET_STACK_GSO_UTILS_H_
 ...
 */
uint16_t packet_stack_gso_max_segment_length(const struct tcp_pcb*);
...
#endif /* _OP_PACKET_STACK_GSO_UTILS_H_ */
