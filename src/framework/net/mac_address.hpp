#ifndef _OP_FRAMEWORK_NET_MAC_ADDRESS_HPP_
#define _OP_FRAMEWORK_NET_MAC_ADDRESS_HPP_
...
inline bool operator==(const mac_address& lhs, const mac_address& rhs)
{
...
#endif /* _OP_FRAMEWORK_NET_MAC_ADDRESS_HPP_ */
