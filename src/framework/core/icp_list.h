 ...
 */
typedef int  (icp_comparator)(const void *thing1, const void *thing2);

/**
 * typedef for function to destroy list items
 */
typedef void (icp_destructor)(void *thing);
 ...
 */
void *icp_list_next(struct icp_list *list,
                    struct icp_list_item **prevp);
 ...
 */
struct icp_list_item *icp_list_item_allocate(void *item);
...
/**
 * Retrieve the data from an icp_list_item
 *
 * @param[in] item
...
#define icp_list_insert_head(list, item)                            \
    _Generic((item),                                                \
             struct icp_list_item *: icp_list_insert_head_item,     \
             default: icp_list_insert_head_value                    \
        )(list, item)

#define icp_list_insert_node(list, start, item)                     \
    _Generic((item),                                                \
             struct icp_list_item *: icp_list_insert_node_item,     \
             default: icp_list_insert_node_value                    \
        )(list, start, item)

#define GET_LIST_INSERT_MACRO(_1, _2, _3, NAME, ...) NAME
#define icp_list_insert(...)                                  \
    GET_LIST_INSERT_MACRO(__VA_ARGS__,                        \
                          icp_list_insert_node,               \
                          icp_list_insert_head)(__VA_ARGS__)
 ...
 */
void *icp_list_find_head(struct icp_list *list,
                         const void *key);
...
#define icp_list_find(...)                                  \
    GET_LIST_FIND_MACRO(__VA_ARGS__,                        \
                        icp_list_find_node,                 \
                        icp_list_find_head)(__VA_ARGS__)
 ...
 */
bool icp_list_delete_head(struct icp_list *list,
                          const void *key);
...
#define icp_list_delete(...)                                  \
    GET_LIST_DELETE_MACRO(__VA_ARGS__,                        \
                          icp_list_delete_node,               \
                          icp_list_delete_head)(__VA_ARGS__)
