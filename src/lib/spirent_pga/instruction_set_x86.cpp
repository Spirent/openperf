...
struct cpuid_extended_bits
{
    ...
    cpuid_extended_bits()
    {
        __cpuid_count(EAX_EXTENDED_BITS, 0, eax.data, ebx.data, ecx.data, edx.data);
    }
};
...
bool available(type t)
{
    ...
    case type::AVX512SKX:
        return (features.ecx.osxsave
                ...
                && xcr0.hi16_zmm
                && extended.ebx.avx2
                && extended.ebx.avx512f
                && extended.ebx.avx512dq
                && extended.ebx.avx512cd
                && extended.ebx.avx512bw
