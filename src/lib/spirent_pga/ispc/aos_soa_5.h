...
inline void
aos_to_soa5(uniform int32 a[], // a0 b0 c0 d0 e0 ... a15 b15 c15 d15 e15
            varying int32* uniform v0,
            varying int32* uniform v1,
            varying int32* uniform v2,
            varying int32* uniform v3,
            varying int32* uniform v4)
{
    static const varying int32 p0 = {
        0, 1, 2, 3, 4, 5, 6, 7, 24, 25, 26, 27, 28, 29, 30, 31};
    static const varying int32 p1a = {
        0, 1, 2, 3, 20, 21, 22, 23, 8, 9, 10, 11, 28, 29, 30, 31};
    static const varying int32 p1b = {
        20, 21, 22, 23, 8, 9, 10, 11, 28, 29, 30, 31, 0, 1, 2, 3};
    static const varying int32 p1c = {
        8, 9, 10, 11, 28, 29, 30, 31, 0, 1, 2, 3, 20, 21, 22, 23};
    static const varying int32 p2a = {
        0, 1, 18, 19, 4, 5, 22, 23, 8, 9, 26, 27, 12, 13, 30, 31};
    static const varying int32 p2b = {
        2, 3, 28, 29, 6, 7, 16, 17, 10, 11, 20, 21, 14, 15, 24, 25};
    static const varying int32 p2c = {
        0, 1, 30, 31, 4, 5, 18, 19, 8, 9, 22, 23, 12, 13, 26, 27};
    static const varying int32 p2d = {
        2, 3, 16, 17, 6, 7, 20, 21, 10, 11, 24, 25, 14, 15, 28, 29};
    static const varying int32 p3a = {
        0, 17, 2, 19, 4, 21, 6, 23, 8, 25, 10, 27, 12, 29, 14, 31};
    static const varying int32 p3b = {
        1, 16, 3, 18, 5, 20, 7, 22, 9, 24, 11, 26, 13, 28, 15, 30};
    ...
    unmasked
    {
        ...
        int32 tmp5 =
            shuffle(tmp0, tmp2, p1a); //  a0  b0  c0  d0  a4  b4  c4  d4
                                      //  a8  b8  c8  d8 a12 b12 c12 d12
        int32 tmp6 =
            shuffle(tmp3, tmp0, p1b); //  e0  a1  b1  c1  e4  a5  b5  c5
                                      //  e8  a9  b9  c9 e12 a13 b13 c13
        int32 tmp7 =
            shuffle(tmp1, tmp3, p1c); //  d1  e1  a2  b2  d5  e5  a6  b6
                                      //  d9  e9 a10 b10 d13 e13 a14 b14
        int32 tmp8 =
            shuffle(tmp4, tmp1, p1a); //  c6  d6  e6  a7 c10 d10 e10 a11
                                      // c14 d14 e14 a15  c2  d2  e2  a3
        int32 tmp9 =
            shuffle(tmp2, tmp4, p1a); //  b3  c3  d3  e3  b7  c7  d7  e7
                                      // b11 c11 d11 e11 b15 c15 d15 e15

        int32 v0v1 =
            shuffle(tmp5, tmp7, p2a); //  a0  b0  a2  b2  a4  b4  a6  b6
                                      //  a8  b8 a10 b10 a12 b12 a14 b14
        int32 v2v3 =
            shuffle(tmp5, tmp8, p2b); //  c0  d0  c2  d2  c4  d4  c6  d6
                                      //  c8  d8 c10 d10 c12 d12 c14 d14
        int32 v4v0 =
            shuffle(tmp6, tmp8, p2c); //  e0  a1  e2  a3  e4  a5  e6  a7
                                      //  e8  a9 e10 a11 e12 a13 e14 a15
        int32 v1v2 =
            shuffle(tmp6, tmp9, p2d); //  b1  c1  b3  c3  b5  c5  b7  c7
                                      //  b9  c9 b11 c11 b13 c13 b15 c15
        int32 v3v4 =
            shuffle(tmp7, tmp9, p2a); //  d1  e1  d3  e3  d5  e5  d7  e7
