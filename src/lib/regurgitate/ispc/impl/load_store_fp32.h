#ifndef _REGURGITATE_IMPL_LOAD_STORE_FP32_H_
#define _REGURGITATE_IMPL_LOAD_STORE_FP32_H_
                               ...
                               uniform uint32 length)
{
    ...
    {
        keys[i] = c[j].keys;
        vals[i] = floatbits(c[j].vals);
        j++;
    }
}

#endif /* _REGURGITATE_IMPL_LOAD_STORE_FP32_H_ */
