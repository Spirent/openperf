#ifndef _LIB_REGURGITATE_INSTRUCTION_SET_HPP_
#define _LIB_REGURGITATE_INSTRUCTION_SET_HPP_
...
enum class type { NONE = 0, AUTO, SSE2, SSE4, AVX, AVX2, AVX512SKX, NEON, MAX };
...
#endif /* _LIB_REGURGITATE_INSTRUCTION_SET_HPP_ */
