...
#define declare_libpacket_enum_flags(Enum)                                     \
    template <> struct libpacket::type::is_enum_flag<Enum> : std::true_type    \
    {}
 ...
 * they were defined in the libpacket::type namespace.
 */
...
constexpr typename std::enable_if_t<
    std::is_enum_v<Enum> && libpacket::type::is_enum_flag<Enum>::value,
    libpacket::type::enumerator<Enum>>
operator&(const Enum& lhs, const Enum& rhs)
{
    using enum_type = std::underlying_type_t<Enum>;
    return (libpacket::type::enumerator<Enum>(static_cast<enum_type>(lhs)
...
constexpr typename std::enable_if_t<
    std::is_enum_v<Enum> && libpacket::type::is_enum_flag<Enum>::value,
    libpacket::type::enumerator<Enum>>
operator&(const libpacket::type::enumerator<Enum>& lhs,
          const libpacket::type::enumerator<Enum>& rhs)
{
    using enum_type = std::underlying_type_t<Enum>;
    return (libpacket::type::enumerator<Enum>(
...
constexpr typename std::enable_if_t<
    std::is_enum_v<Enum> && libpacket::type::is_enum_flag<Enum>::value,
    libpacket::type::bit_flags<Enum>>
operator&(const libpacket::type::bit_flags<Enum>& lhs,
          const libpacket::type::bit_flags<Enum>& rhs)
{
    return (libpacket::type::bit_flags<Enum>(lhs.value & rhs.value));
}
...
constexpr typename std::enable_if_t<
    std::is_enum_v<Enum> && libpacket::type::is_enum_flag<Enum>::value,
    libpacket::type::enumerator<Enum>>
operator&(const Enum& lhs, const libpacket::type::enumerator<Enum>& rhs)
{
    using enum_type = std::underlying_type_t<Enum>;
    return (libpacket::type::enumerator<Enum>(
...
constexpr typename std::enable_if_t<
    std::is_enum_v<Enum> && libpacket::type::is_enum_flag<Enum>::value,
    libpacket::type::enumerator<Enum>>
operator&(const libpacket::type::enumerator<Enum>& lhs, const Enum& rhs)
{
    using enum_type = std::underlying_type_t<Enum>;
    return (libpacket::type::enumerator<Enum>(static_cast<enum_type>(lhs.value)
                                              & static_cast<enum_type>(rhs)));
}
...
constexpr typename std::enable_if_t<
    std::is_enum_v<Enum> && libpacket::type::is_enum_flag<Enum>::value,
    libpacket::type::enumerator<Enum>>
operator&(const Enum& lhs, const libpacket::type::bit_flags<Enum>& rhs)
{
    using enum_type = std::underlying_type_t<Enum>;
    return (libpacket::type::enumerator<Enum>(static_cast<enum_type>(lhs)
                                              & rhs.value));
...
constexpr typename std::enable_if_t<
    std::is_enum_v<Enum> && libpacket::type::is_enum_flag<Enum>::value,
    libpacket::type::enumerator<Enum>>
operator&(const libpacket::type::bit_flags<Enum>& lhs, const Enum& rhs)
{
    using enum_type = std::underlying_type_t<Enum>;
    return (libpacket::type::enumerator<Enum>(lhs.value
                                              & static_cast<enum_type>(rhs)));
}
...
{
    using enum_type = std::underlying_type_t<Enum>;
    return (libpacket::type::bit_flags<Enum>(static_cast<enum_type>(lhs)
                                             | static_cast<enum_type>(rhs)));
}
...
{
    using enum_type = std::underlying_type_t<Enum>;
    return (libpacket::type::bit_flags<Enum>(
        static_cast<enum_type>(lhs.value) | static_cast<enum_type>(rhs.value)));
}
...
{
    using enum_type = std::underlying_type_t<Enum>;
    return (libpacket::type::bit_flags<Enum>(static_cast<enum_type>(lhs.value)
                                             | static_cast<enum_type>(rhs)));
}
...
{
    using enum_type = std::underlying_type_t<Enum>;
    return (libpacket::type::bit_flags<Enum>(lhs.value
                                             | static_cast<enum_type>(rhs)));
}
...
constexpr typename std::enable_if_t<
    std::is_enum_v<Enum> && libpacket::type::is_enum_flag<Enum>::value,
    libpacket::type::bit_flags<Enum>>
operator&=(libpacket::type::bit_flags<Enum>& lhs, const Enum& rhs)
{
    using enum_type = std::underlying_type_t<Enum>;
...
constexpr typename std::enable_if_t<
    std::is_enum_v<Enum> && libpacket::type::is_enum_flag<Enum>::value,
    libpacket::type::bit_flags<Enum>>
operator&=(libpacket::type::bit_flags<Enum>& lhs,
           const libpacket::type::enumerator<Enum>& rhs)
{
    using enum_type = std::underlying_type_t<Enum>;
    lhs.value &= static_cast<enum_type>(rhs.value);
...
operator~(const libpacket::type::enumerator<Enum>& lhs)
{
    using enum_type = std::underlying_type_t<Enum>;
    return (
        libpacket::type::bit_flags<Enum>(~static_cast<enum_type>(lhs.value)));
}
