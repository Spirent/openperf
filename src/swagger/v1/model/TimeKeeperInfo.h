...
public:
    ...
    /// <summary>
    /// The TimeCounter frequency as measured by the interval between the two best timestamp exchanges over the past two hours, in hz. 
    /// </summary>
    ...
    /// <summary>
    /// The TimeCounter frequency as measured by the interval between the two best timestamp exchanges over the past hour, in hz. This value is used to help determine TimeCounter drift. 
    /// </summary>
    ...
    /// <summary>
    /// The offset applied to TimeCounter derived timestamp values, in seconds. 
    /// </summary>
    ...
    void unsetSynced();
    /// <summary>
    /// The calculated correction to apply to the offset, based on the measured TimeCounter frequency and timestamp exchanges. 
    /// </summary>
