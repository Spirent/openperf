...
*/
/*
 * NetworkGeneratorStats.h
 *
 * Network generator statistics
 */

#ifndef NetworkGeneratorStats_H_
#define NetworkGeneratorStats_H_
...
/// Network generator statistics
/// </summary>
class  NetworkGeneratorStats
    : public ModelBase
{
public:
    NetworkGeneratorStats();
    virtual ~NetworkGeneratorStats();
...
#endif /* NetworkGeneratorStats_H_ */
