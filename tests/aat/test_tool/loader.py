...
from example_group import ExampleGroup, PendingExampleGroup, SharedExampleGroup
from example import Example, PendingExample
...
class Loader(object):
    ...
    def _load_helper_methods(self, klass, example_group):
        helper_methods = [method for name, method in self._methods_for(
            klass) if not self._is_example(method)]
