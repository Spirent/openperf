...
> BulkStartBlockGeneratorsResponse bulk_start_block_generators(bulk_start)
...
[**BulkStartBlockGeneratorsResponse**](BulkStartBlockGeneratorsResponse.md)
...
> start_block_generator(id)

Start a block generator

Start an existing block generator. Idempotent.
...
try:
    # Start a block generator
    api_instance.start_block_generator(id)
except ApiException as e:
