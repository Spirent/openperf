...
> CpuGeneratorsResponse bulk_start_cpu_generators(bulk_start)
...
bulk_start = client.CpuGeneratorsRequest() # CpuGeneratorsRequest | Bulk start
...
------------- | ------------- | ------------- | -------------
 **bulk_start** | [**CpuGeneratorsRequest**](CpuGeneratorsRequest.md)| Bulk start | 

### Return type

[**CpuGeneratorsResponse**](CpuGeneratorsResponse.md)
...
# create an instance of the API class
api_instance = client.CpuGeneratorApi()
bulk_stop = client.CpuGeneratorsRequest1() # CpuGeneratorsRequest1 | Bulk stop
...
Name | Type | Description  | Notes
------------- | ------------- | ------------- | -------------
 **bulk_stop** | [**CpuGeneratorsRequest1**](CpuGeneratorsRequest1.md)| Bulk stop | 
...
# **start_cpu_generator**
> start_cpu_generator(id)

Start a CPU generator

Start an existing CPU generator. Idempotent.
...
try:
    # Start a CPU generator
    api_instance.start_cpu_generator(id)
except ApiException as e:
