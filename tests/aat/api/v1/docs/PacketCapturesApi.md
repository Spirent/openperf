...
api_instance = client.PacketCapturesApi()
id = 'id_example' # str | Unique resource identifier
packet_start = 'packet_start_example' # str | The packet offset in the capture buffer to start reading (0 based) (optional)
packet_end = 'packet_end_example' # str | The packet offset in the capture buffer to end reading (0 based) (optional)
...
------------- | ------------- | ------------- | -------------
 **id** | **str**| Unique resource identifier | 
 **packet_start** | **str**| The packet offset in the capture buffer to start reading (0 based) | [optional] 
 **packet_end** | **str**| The packet offset in the capture buffer to end reading (0 based) | [optional] 
