...
class AnalyzersApi(object):
    ...
    def get_rx_stream(self, id, **kwargs):  # noqa: E501
        ...
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.get_rx_stream(id, async_req=True)
        >>> result = thread.get()
    ...
    def get_rx_stream_with_http_info(self, id, **kwargs):  # noqa: E501
        ...
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.get_rx_stream_with_http_info(id, async_req=True)
        >>> result = thread.get()
    ...
    def list_rx_streams(self, **kwargs):  # noqa: E501
        ...
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.list_rx_streams(async_req=True)
        >>> result = thread.get()
    ...
    def list_rx_streams_with_http_info(self, **kwargs):  # noqa: E501
        ...
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.list_rx_streams_with_http_info(async_req=True)
        >>> result = thread.get()
