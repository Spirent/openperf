...
class PacketCapturesApi(object):
    ...
    def get_packet_capture_pcap(self, id, **kwargs):  # noqa: E501
        ...
        :param async_req bool
        :param str id: Unique resource identifier (required)
        :param str packet_start: The packet offset in the capture buffer to start reading (0 based)
        :param str packet_end: The packet offset in the capture buffer to end reading (0 based)
        :return: file
                 If the method is called asynchronously,
                 returns the request thread.
        """
