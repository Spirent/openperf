...
class TVLPApi(object):
    ...
    def start_tvlp_configuration(self, id, **kwargs):  # noqa: E501
        ...
        :param TvlpStartConfiguration tvlp_start_configuration: Dynamic results configuration
        :return: TvlpResult
                 If the method is called asynchronously,
                 returns the request thread.
        """
    ...
    def start_tvlp_configuration_with_http_info(self, id, **kwargs):  # noqa: E501
        ...
        all_params = ['id', 'time', 'tvlp_start_configuration']  # noqa: E501
        all_params.append('async_req')
        all_params.append('_return_http_data_only')
        all_params.append('_preload_content')
        all_params.append('_request_timeout')
        ...
        body_params = None
        if 'tvlp_start_configuration' in params:
            body_params = params['tvlp_start_configuration']
        # HTTP header `Accept`
        header_params['Accept'] = self.api_client.select_header_accept(
            ['application/json'])  # noqa: E501
