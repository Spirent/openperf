...
class TimeKeeperInfo(object):
    ...
    def frequency(self):
        ...
        The TimeCounter frequency as measured by the interval between the two best timestamp exchanges with the TimeSource over the past two hours, in hz.   # noqa: E501
    ...
    def local_frequency(self):
        ...
        The TimeCounter frequency as measured by the interval between the two best timestamp exchanges with the TimeSource over the past hour, in hz. This value is used to help determine TimeCounter drift.   # noqa: E501
    ...
    def offset(self):
        ...
        The offset applied to TimeCounter derived timestamp values, in seconds.  This value comes from the system host clock.   # noqa: E501
    ...
    def theta(self):
        ...
        The calculated correction to apply to the offset, based on the measured TimeCounter frequency and TimeSource timestamps.   # noqa: E501
