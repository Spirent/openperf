...
class BulkDeleteCpuGeneratorsRequest(object):
    ...
    def __init__(self, ids=None):  # noqa: E501
        """BulkDeleteCpuGeneratorsRequest - a model defined in Swagger"""  # noqa: E501
    ...
    def to_dict(self):
        ...
        for attr, _ in six.iteritems(self.swagger_types):
            ...
            if isinstance(value, list):
                ...
                result[attr] = value
        if issubclass(BulkDeleteCpuGeneratorsRequest, dict):
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, BulkDeleteCpuGeneratorsRequest):
            return False
