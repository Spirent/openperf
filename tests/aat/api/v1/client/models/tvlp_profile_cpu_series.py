...
class TvlpProfileCpuSeries(object):
    ...
    @property
    def config(self):
        """Gets the config of this TvlpProfileCpuSeries.  # noqa: E501


        :return: The config of this TvlpProfileCpuSeries.  # noqa: E501
    ...
    def config(self, config):
        """Sets the config of this TvlpProfileCpuSeries.


        :param config: The config of this TvlpProfileCpuSeries.  # noqa: E501
    ...
    def to_dict(self):
        ...
        for attr, _ in six.iteritems(self.swagger_types):
            ...
            if isinstance(value, list):
                ...
                result[attr] = value
        if issubclass(TvlpProfileCpuSeries, dict):
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, TvlpProfileCpuSeries):
            return False
