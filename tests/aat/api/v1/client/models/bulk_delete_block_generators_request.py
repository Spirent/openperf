...
class BulkDeleteBlockGeneratorsRequest(object):
    ...
    def __init__(self, ids=None):  # noqa: E501
        """BulkDeleteBlockGeneratorsRequest - a model defined in Swagger"""  # noqa: E501
    ...
    def to_dict(self):
        ...
        for attr, _ in six.iteritems(self.swagger_types):
            ...
            if isinstance(value, list):
                ...
                result[attr] = value
        if issubclass(BulkDeleteBlockGeneratorsRequest, dict):
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, BulkDeleteBlockGeneratorsRequest):
            return False
