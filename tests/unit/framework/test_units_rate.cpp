...
TEST_CASE("rates", "[rate]")
{
    ...
    SECTION("static, ")
    {
        ...
        REQUIRE(double_rate::min().count()
                == std::numeric_limits<double>::lowest());
        REQUIRE(double_rate::max().count()
    ...
    SECTION("data rates, ")
    {
        ...
        {
            using kbps =
                openperf::units::rate<uint64_t, openperf::units::kilobits>;
            using Kibps =
                openperf::units::rate<uint64_t, openperf::units::kibibits>;
            using kBps =
                openperf::units::rate<uint64_t, openperf::units::kilobytes>;
            using KiBps =
                openperf::units::rate<uint64_t, openperf::units::kibibytes>;
        ...
        {
            using Mbps =
                openperf::units::rate<uint64_t, openperf::units::megabits>;
            using Mibps =
                openperf::units::rate<uint64_t, openperf::units::mebibits>;
            using MBps =
                openperf::units::rate<uint64_t, openperf::units::megabytes>;
            using MiBps =
                openperf::units::rate<uint64_t, openperf::units::mebibytes>;
        ...
        {
            using Gbps =
                openperf::units::rate<uint64_t, openperf::units::gigabits>;
            using Gibps =
                openperf::units::rate<uint64_t, openperf::units::gibibits>;
            using GBps =
                openperf::units::rate<uint64_t, openperf::units::gigabytes>;
            using GiBps =
                openperf::units::rate<uint64_t, openperf::units::gibibytes>;
        ...
        {
            using Tbps =
                openperf::units::rate<uint64_t, openperf::units::terabits>;
            using Tibps =
                openperf::units::rate<uint64_t, openperf::units::tebibits>;
            using TBps =
                openperf::units::rate<uint64_t, openperf::units::terabytes>;
            using TiBps =
                openperf::units::rate<uint64_t, openperf::units::tebibytes>;
