...
BLOCK_LIB_DIR := $(OP_BUILD_ROOT)/plugins
...
BLOCK_TARGET := $(BLOCK_LIB_DIR)/lib$(BLOCK_LIBRARY).so
...
# Build rules
###
$(eval $(call op_generate_build_rules,$(BLOCK_SOURCES),BLOCK_SRC_DIR,BLOCK_OBJ_DIR,BLOCK_DEPENDS,BLOCK_FLAGS))
$(eval $(call op_generate_clean_rules,block,BLOCK_TARGET,BLOCK_OBJECTS))

$(BLOCK_TARGET): $(BLOCK_OBJECTS)
	$(call op_link_plugin,$@,$(BLOCK_OBJECTS))
