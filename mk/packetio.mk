...
$(call icp_include_dependencies,$(PIO_DEPENDS))
...
# Build rules
###
$(eval $(call icp_generate_build_rules,$(PIO_SOURCES),PIO_SRC_DIR,PIO_OBJ_DIR,PIO_DEPENDS,PIO_FLAGS))
$(eval $(call icp_generate_clean_rules,packetio,PIO_TARGET,PIO_OBJECTS))

$(PIO_TARGET): $(PIO_OBJECTS) $(LWIP_OBJECTS)
	$(call icp_link_library,$@,$(PIO_OBJECTS) $(LWIP_OBJECTS))
