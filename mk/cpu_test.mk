...
CPU_TEST_DEFINES :=
CPU_TEST_ISPC_DEFINES := CPU_PARALLELIZE_ALGORITHM
...
CPU_TEST_FLAGS := -DARCH="\"$(ARCH)\"" -mpclmul $(addprefix -D,$(CPU_TEST_DEFINES))
...
$(eval $(call op_generate_clean_rules,cpu,CPU_TEST_TARGET,CPU_TEST_OBJECTS))
...
$(CPU_TEST_OBJ_DIR)/%.o: $(CPU_TEST_SRC_DIR)/%.ispc
	@mkdir -p $(dir $@)
	$(strip $(OP_ISPC) $(addprefix -D,$(CPU_TEST_ISPC_DEFINES)) \
		-o $@ $(CPU_TEST_ISPC_OPTS) \
		-M -MF $(@:.o=.d) \
