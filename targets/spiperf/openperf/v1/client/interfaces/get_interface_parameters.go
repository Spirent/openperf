...
// NewGetInterfaceParams creates a new GetInterfaceParams object
...
// NewGetInterfaceParamsWithTimeout creates a new GetInterfaceParams object
...
// NewGetInterfaceParamsWithContext creates a new GetInterfaceParams object
...
// NewGetInterfaceParamsWithHTTPClient creates a new GetInterfaceParams object
...
for the get interface operation typically these are written to a http.Request
*/
...
func (o *GetInterfaceParams) WithContext(ctx context.Context) *GetInterfaceParams {
	o.SetContext(ctx)
	return o
}
...
func (o *GetInterfaceParams) WithID(id string) *GetInterfaceParams {
	o.SetID(id)
	return o
}
