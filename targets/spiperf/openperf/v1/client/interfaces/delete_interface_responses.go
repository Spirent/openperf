...
func (o *DeleteInterfaceReader) ReadResponse(response runtime.ClientResponse, consumer runtime.Consumer) (interface{}, error) {
	...
	case 204:
		result := NewDeleteInterfaceNoContent()
...
func NewDeleteInterfaceNoContent() *DeleteInterfaceNoContent {
	return &DeleteInterfaceNoContent{}
}

/*DeleteInterfaceNoContent handles this case with default header values.
...
func (o *DeleteInterfaceNoContent) Error() string {
	return fmt.Sprintf("[DELETE /interfaces/{id}][%d] deleteInterfaceNoContent ", 204)
}

func (o *DeleteInterfaceNoContent) readResponse(response runtime.ClientResponse, consumer runtime.Consumer, formats strfmt.Registry) error {
